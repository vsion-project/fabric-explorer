docker exec orderer-cli sh -c 'peer channel fetch config config_block.pb -o orderer.criptovision.com:7050 -c system-channel --tls --cafile $ORDERER_CA'
...
docker exec orderer-cli sh -c 'peer channel update -f config_update_in_envelope.pb -c system-channel -o orderer.criptovision.com:7050 --tls true --cafile $ORDERER_CA'
