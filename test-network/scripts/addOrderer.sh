...
docker exec orderer.criptovision.com ls -lh /var/hyperledger/production/orderer/chains/system-channel
docker exec orderer2.criptovision.com ls -lh /var/hyperledger/production/orderer/chains/system-channel

echo "Application channel Size (before channel update)"
docker exec orderer.criptovision.com ls -lh /var/hyperledger/production/orderer/chains/mychannel
docker exec orderer2.criptovision.com ls -lh /var/hyperledger/production/orderer/chains/mychannel
