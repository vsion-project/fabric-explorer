...
docker exec orderer-cli sh -c 'peer channel fetch config config_block.pb -o orderer.criptovision.com:7050 -c mychannel --tls --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/criptovision.com/orderers/orderer.criptovision.com/msp/tlscacerts/tlsca.criptovision.com-cert.pem'
...
docker exec orderer-cli sh -c 'peer channel update -f config_update_in_envelope.pb -c mychannel -o orderer.criptovision.com:7050 --tls true --cafile /opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/ordererOrganizations/criptovision.com/orderers/orderer.criptovision.com/msp/tlscacerts/tlsca.criptovision.com-cert.pem'
